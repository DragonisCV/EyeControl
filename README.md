...
| EyeControl | Retouching checkpoint | [Hugging Face (TBD)](https://huggingface.co/black-forest-labs/FLUX.1-Kontext-dev) → `pretrained/eyecontrol` |
